        ...
        if os.path.isdir(video_folder_path):
            ...
            for filename in os.listdir(video_folder_path):
                ...
                if len(face_encodings_in_frame) == 1:
                    ...
                    # Append face encoding and label (video folder name) to the lists
...
if __name__ == "__main__":
    ...
    output_model_path = r"D:\\Computer Vision\\face_detection_model.joblib"  # Adjust the path accordingly
    output_encoder_path = r"D:\\Computer Vision\\face_encoder_labels.joblib"  # Adjust the path accordingly
